                    ...
                    <tbody>
                        ...
                        @foreach (session('panier') as $key => $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    <strong><a href="{{ route('chaussure.show', $key) }}"
                                            title="Afficher le produit">{{ $item['nom_chaussure'] }}</a></strong>
                                </td>
                                <td>{{ $item['prix'] }} Fcfa</td>
                                <td>
                                    <!-- Le formulaire de mise à jour de la quantité -->
                                    <form method="POST" action="{{ route('panier.add', $key) }}"
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('panier.remove', $key) }}" class="btn btn-outline-danger"
